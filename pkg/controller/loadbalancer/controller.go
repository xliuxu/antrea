...
func (c *LoadBalancerController) restoreIPAllocations(services []*corev1.Service) {
...
func (c *LoadBalancerController) setIPAllocation(name apimachinerytypes.NamespacedName, ipPool string, ip net.IP) {
