...
func newFakeController(t *testing.T, objs ...runtime.Object) *fakeController {
	...
	return &fakeController{
		LoadBalancerController: lbController,
...
func TestCreateService(t *testing.T) {
	tests := []struct {
		...
		expectedLBStates  map[apimachinerytypes.NamespacedName]loadBalancerState
		expectedError     bool
	}{
		{
			...
			map[apimachinerytypes.NamespacedName]loadBalancerState{
...
func TestUpdateService(t *testing.T) {
	...
	tests := []struct {
		...
		previousLBStates map[apimachinerytypes.NamespacedName]loadBalancerState
		expectedLBStates map[apimachinerytypes.NamespacedName]loadBalancerState
		healthyNodes     []string
		expectedCalls    func(mockIPAssigner *ipassignertest.MockIPAssigner)
		expectedError    bool
